   ...
   extends JBossCacheClusteredSession
{
    ...
    * </p>
    * 
    * @see org.jboss.web.tomcat.tc6.session.ClusteredSession#readExternal(java.io.ObjectInput)
    */
    ...
    * 
    * @see org.jboss.web.tomcat.tc6.session.ClusteredSession#writeExternal(java.io.ObjectOutput)
    */
